...
<body>
    ...
    <div class="container-fluid page-header2 py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Hydromecanique</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Accueil</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Hydromecanique</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div class="row g-5">
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                <p class="fw-medium text-uppercase mb-2">Hydromecanique</p>
                <p class="mb-4" style="text-align: justify;">
                    Notre société, experte en hydromécanique, se consacre à la maîtrise des principes de la mécanique des fluides, spécifiquement appliquée aux systèmes et équipements liés à l'eau, y compris l'eau potable. Notre champ d'expertise s'étend à l'ingénierie des procédés essentiels pour le traitement et la distribution de l'eau potable, un secteur vital qui garantit la qualité et la sécurité de l'eau pour tous. Nous concevons, développons et optimisons des solutions avancées pour le traitement de l'eau potable, en plus de nos activités dans l'énergie hydroélectrique, l'irrigation et le contrôle des inondations. Notre approche intègre la conception de composants tels que turbines, pompes et vannes, adaptés au secteur de l'eau potable, visant l'amélioration continue de l'efficacité, de la durabilité et de la fiabilité des installations hydromécaniques. Nous nous engageons à répondre aux défis spécifiques de nos clients en fournissant des solutions personnalisées qui allient innovation technologique et respect des normes environnementales.
                </p>
            </div>
        </div>
    </div>
