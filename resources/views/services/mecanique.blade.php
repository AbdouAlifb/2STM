...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Mécanique</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Accueil</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Mécanique</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div style="position: absolute; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.9) url('/img/logo.jpeg') no-repeat center center; background-size: 35%; opacity: 0.3; top: 0; left: 0; z-index: -1;"></div>
    <div class="container" style="position: relative; z-index: 1;">
        <div class="row g-5">
            <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                <p class="fw-medium text-uppercase text-primary mb-2">Mécanique</p>
                <p class="mb-4" style="text-align: justify;">
                    Notre équipe propose une offre mécanique complète. Ensembles mécaniques, moto réducteurs, pompes, vannes, transmission, vérins, sont quelques exemples des interventions mécaniques que nous effectuons. Notre équipe dispose de tout l'outillage nécessaire à ses interventions mécaniques. Du chauffe roulement, à la presse, en passant par les arrache moyeux, etc. mais aussi des moyens de tournage et de fraisage, Notre équipe dispose en interne de tous les moyens et compétences pour mener à bien les projets mécaniques. Nos véhicules atelier sont également dotés d'un éventail important d'outillage mécanique.
                </p>
            </div>
        </div>
    </div>
