        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Flexible et Garniture</a></li>
...
2STM dispose d’un matériel adapté pour réaliser sur demande le dépannage nécessaire. Sans rendez-vous, nous réparons directement vos flexibles hydrauliques, sur demande, et en adéquation avec le matériel à dépanner.
...
De plus, Atelier se chargent de la remise en état de transmissions hydrostatiques, des pompes et moteurs TP/AGRI. Les problèmes sont identifiés, et réglés à travers la pièce idéale, adaptée au modèle de votre engin.
                    ...
                    <h1 class="display-5 mb-4">GARNITURE FREIN</h1>
                    <p class="mb-4"  style="text-align: justify;">
                    Plaquettes sur mesure, rectification et regarnissage de tambours de frein, rectification de disques de frein, 
                    regarnissage de patins de frein. Garnitures racine pour les patins de frein.</p>
                     

                    
                    <h1 class="display-5 mb-4">GARNITURE EMBRAYAGE</h1>
                    <p class="mb-4"  style="text-align: justify;">
                    Regarnissage de disques d'embrayage, renforcement de disques d'embrayage,
                     rectification de volants moteur. Garniture racine pour les disques d'embrayage.</p>
                </div>
            </div>
        </div>
    </div>
