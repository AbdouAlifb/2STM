        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tournage</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                    <p class="fw-medium text-uppercase text-primary mb-2">Tournage</p>
                    <!-- <h1 class="display-5 mb-4">Nous sommes leaders sur le marché industriel</h1> -->
                    <p class="mb-4"  style="text-align: justify;">
                    Grâce à une équipe qualifiée et disponible, nous mettrons en œuvre tout ce qui sera nécessaire pour répondre au mieux à vos demandes et besoins dans les meilleurs délais.
Equipè de 4 tours, capacité du 3 mètres jusque 6 mètres d'entre pointe.

Nos connaissances diversifiées nous permettent de répondre à toutes vos attentes que ce soit en réparation (Tournage, Alésage, Filetage Rectification, etc.).
Aussi sur la fabrication de tous types de pièces selon un modèle ou un plan et dans la matière de votre choix (Acier, Aluminium, Inox, Bronze, Aciers spéciaux, Plastique, Bakélite, Etc.).
                    </p>
