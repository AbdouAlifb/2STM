...
<body>
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header6 py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Maintenance</h1>
        ...
        <div class="container" style="position: relative; z-index: 1;">
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                    <p class="fw-medium text-uppercase text-primary mb-2">Maintenance</p>
...
à vos problématiques et coûts de maintenance.

Nous trouverons toujours des solutions à vos questions !
Notre équipe 2STM intervient de plusieurs manières : 
<ul>
    <li>Ponctuellement, sur demande spécifique</li>
    <li>Régulièrement, sous forme d'un contrat de maintenance et sur un périmètre défini</li>
    <li>Dans l'urgence, en dépannage grâce à nos équipes d'astreinte.</li>
