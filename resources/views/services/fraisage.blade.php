...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5 wow fadeIn" data-wow-delay="0.1s">
        <div class="container py-5">
            <h1 class="display-3 text-white animated slideInRight">Fraisage</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb animated slideInRight mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('home') }}">Accueil</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Fraisage</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div style="position: absolute; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.9) url('/img/logo.jpeg') no-repeat center center; background-size: 30%; opacity: 0.3; top: 0; left: 0; z-index: -1;"></div>
  
            <div class="row g-5">
                
                <div class="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
                    <p class="fw-medium text-uppercase text-primary mb-2">Fraisage</p>
...
Notre rapidité et la grande diversité de notre clientèle, nous permet de répondre au mieux à toutes vos demandes de réparation (arbres, pignons, châssis, bagues, etc.).

Aussi pour vos fabrications de pièces (taillages pignons, alésage, surfaçage, prototype, etc.) selon un plan ou un modèle et selon vos exigences.
                    </p>
