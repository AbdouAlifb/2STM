...
<head>
    ...
    <!--Start of Tawk.to Script-->
        <script type="text/javascript">
                    ...
                    s1.async=true;
                    s1.src='https://embed.tawk.to/660845a3a0c6737bd126858d/1hq8501u1';
                    s1.charset='UTF-8';
                ...
                <div class="col-lg-6">
                    <div class="row gx-3 h-100">
                        <div class="col-6 align-self-start wow fadeInUp" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/about-1N.jpg">
                        </div>
                        <div class="col-6 align-self-end wow fadeInDown" data-wow-delay="0.1s">
                            <img class="img-fluid" src="img/about-2N.jpg">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-12">
                            <div class="d-flex">
                                ...
                                <div class="ms-4">
                                    <h4>Services industriels fiables</h4>
